    ...
    <div class="container">
        <div class="about-strip">
            ...
            <div class="about-strip__image reveal">
                ...
                <div style="width:100%;height:100%;min-height:380px;background:linear-gradient(135deg,var(--green-light),var(--border));border-radius:var(--radius-md);display:flex;align-items:center;justify-content:center;font-size:5rem;">
                    <img src="<?= URLROOT ?>/images/about-page.jpg" alt="Pinga Agro Investment Limited">
                </div>
            </div>
        </div>
    </div>
...
<section class="section section--dark">
    <div class="container" style="text-align:center;">
        <div class="reveal">
            ...
            <h2 style="color:var(--white);margin-bottom:1rem;">Ready to Engage with Pinga Agro?</h2>
            <p style="color:rgba(255,255,255,0.72);max-width:520px;margin:0 auto 2rem;font-size:var(--text-md);">Whether you're a farmer seeking support, an investor exploring opportunities, or a government body looking for a credible partner — we'd love to hear from you.</p>
            <a href="<?= URLROOT ?>/contact" class="btn btn-primary">Get In Touch</a>
        </div>
    </div>
</section>